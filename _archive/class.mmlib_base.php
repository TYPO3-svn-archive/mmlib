...
****************************************************************
require_once(t3lib_extMgm::extPath('wow_character').'mmlib/class.mmlib_base.php');
***************************************************************/
...
class mmlib_base {
	...
	public function mmlib_base(array $conf){
		...
		if(!$this->data)throw new Exception('mmlib_base: no data found');
	}
  ...
  public function __get($name){
	...
	public function __set($name,$value){
		if(!$this->data[$name])throw new Exception('mmlib_base: value \''.$name.'\' does not exist');
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/wow_character/mmlib/class.mmlib_base.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/wow_character/mmlib/class.mmlib_base.php']);
}
?>