...
$TYPO3_CONF_VARS['SC_OPTIONS']['tslib/class.tslib_content.php']['cObjTypeAndClass'][] = array('LOAD_SESSION', 'EXT:mmlib/hooks/class.tx_mmlib_session.php:tx_mmlib_session' );
...
$TYPO3_CONF_VARS['SC_OPTIONS']['tslib/class.tslib_content.php']['getData'][] = 'EXT:mmlib/hooks/class.tx_mmlib_stdwrap.php:&tx_mmlib_stdwrap';
...
$TYPO3_CONF_VARS['SC_OPTIONS']['tslib/class.tslib_fe.php']['checkAlternativeIdMethods-PostProc']['tx_mmlib'] = 'EXT:mmlib/hooks/class.tx_mmlib_fe.php:tx_mmlib_fe->checkAlternativeIdMethodsPostProc';
$TYPO3_CONF_VARS['SC_OPTIONS']['tslib/class.tslib_fe.php']['contentPostProc-all']['tx_mmlib'] = 'EXT:mmlib/hooks/class.tx_mmlib_fe.php:tx_mmlib_fe->contentPostProcAll';
